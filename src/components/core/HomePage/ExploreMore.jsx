...
const ExploreMore = () =>{
    ...
    return(
      ...
      rounded-full font-medium drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] mt-5">
            ...
            <div
              className={` text-[16px] flex flex-row items-center gap-2 ${
                currentTab === ele
                  ...
                  : "text-richblack-200"
              } px-7 py-[7px] rounded-full transition-all duration-200 cursor-pointer hover:bg-richblack-900 
      ...
      lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-7 lg:px-0 px-3">
