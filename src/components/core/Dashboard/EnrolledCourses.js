...
export default function EnrolledCourses() {
  ...
  return (
    <>
      <div className="text-3xl text-richblack-50 tracking-wider lg:text-left text-center">Enrolled Courses</div>
      {!enrolledCourses ? (
              ...
              >
                ...
                >
                  ...
                  <div className="flex max-w-xs flex-col gap-2">
                    <p className="font-semibold tracking-wider">{course.courseName}</p>
