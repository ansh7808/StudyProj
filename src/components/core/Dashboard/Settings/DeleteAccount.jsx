  ...
  return (
    <div className=' mt-7 rounded-md border border-pink-700 bg-pink-900 p-8 px-5 md:px-12' >
      <div className='flex gap-x-5 ' >
        ...
        aspect-square h-14 w-14  rounded-full bg-pink-700'onClick={() => handleDeleteAccount()} >
          <FiTrash2 className='text-3xl text-pink-200' />
        </div>

        <div className='flex flex-col space-y-2 ' >
          <h2 className='text-lg font-semibold text-richblack-5 tracking-wider'>Delete Account</h2>
