    ...
    <div className='flex items-center justify-between rounded-md border border-richblack-700 bg-richblack-800 p-8 px-2 md:px-12'>
      <div className='flex gap-x-4 items-center ' >
        ...
        <div className='space-y-2'>
          <h2 className='lg:text-lg text-md font-semibold text-richblack-5 tracking-wider'>Change Profile Picture</h2>
          <div className='flex gap-x-3' >

            <input type="file" ref={fileInputRef} onChange={handleFileChange} className='hidden'
              accept='image/jpeg, image/gif image/jpg image/png' />

            <button onClick={handleClick} disabled={loading} className={` bg-richblack-600 text-richblack-50 
            lg:py-2 py-1 lg:px-5 px-2 font-semibold rounded-md tracking-wider 
