    ...
    <div>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        <div className='my-5 rounded-md border border-richblack-700 bg-richblack-800 py-8 px-5 md:px-12'>
          <h1 className='text-lg mb-6 font-semibold text-richblack-5  tracking-wider'>Profile Information</h1>

          <div className='flex flex-col gap-y-6'>
            <div className='flex flex-col md:flex-row gap-5'>

              <label className='w-full' >
                <p className='label-style tracking-wider mb-1'>First Name <span className='text-pink-100'>*</span></p>
                <input
                  type='text'
                  name='firstName'
                 ...
                 form-style placeholder:uppercase placeholder:text-sm placeholder:tracking-wider"
              ...
              <label className='w-full' >
                <p className='label-style  tracking-wider mb-1' >Last Name <span className='text-pink-100'>*</span></p>
                <input
                  type='text'
                  name='lastName'
                 ...
                 className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5 
                 form-style placeholder:text-sm placeholder:tracking-wider"
            ...
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                <p className='label-style tracking-wider mb-1' >Date of Birth <span className='text-pink-100'>*</span></p>
                <input
                  type='date'
                  name='dob'
              ...
              <label className='w-full' >
                <p className='label-style tracking-wider mb-1' >Gender <span className='text-pink-100'>*</span></p>
                <select
                  type='text'
                  name='gender'
                  style={{
            ...
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                <p className='label-style tracking-wider mb-1' >Contact Number <span className='text-pink-100'>*</span></p>
                <input
                  type='tel'
                  name='contactNumber'
        ...
        <div className='flex justify-end gap-2'>
          <button onClick={() => navigate('/dashboard/my-profile')} className={`rounded-md bg-richblack-700 lg:py-2 py-1
           lg:px-5 px-2 font-semibold text-richblack-50 tracking-wider 
