            ...
            <div className="flex flex-col gap-y-2 py-5 px-5">
              ...
              {token === null && (
                <Link to={"/login"} onClick={() => setIsMenuModalOpen(false)}>
                  <div className="flex gap-x-2 items-center w-full py-2 px-3 text-richblack-100 hover:text-richblack-25 hover:bg-richblack-700  tracking-wider">
              ...
              {token !== null && (
                <div
                  className="flex gap-x-2 items-center w-full py-2 px-3 text-richblack-100 hover:text-richblack-25 hover:bg-richblack-700 cursor-pointer  tracking-wider"
              ...
              >
                <details>
                  <summary className="flex gap-x-2 items-center w-full py-2 px-3 text-richblack-100 tracking-wider">
                      ...
                      <div className="flex flex-col capitalize">
                        {subLinks.map((subLink, index) => (
                          <Link
                            ...
                            onClick={() => setIsMenuModalOpen(false)}
                          >
                            <p className=" rounded-lg py-2 pl-4 tracking-wider text-xs">
                              {subLink.name}
                            </p>
                          </Link>
                        ))}
...
//                        transition-all duration-150 group-hover:visible group-hover:translate-y-[1.65em] group-hover:opacity-100 
//                        lg:w-[300px]">
...
//                {token === null && (
//             <Link to="/login">
//               <button className="rounded-[8px] border border-richblack-700 bg-richblack-800 px-[10px] py-[6px]
//                text-richblack-100 ">
//                 Log In
//               </button>
//             </Link>
...
//           {token === null && (
//             <Link to="/signup">
//               <button className="rounded-[8px] border border-richblack-700 bg-richblack-800 px-[10px] 
//               py-[6px] text-richblack-100 ">
//                 Sign Up
//               </button>
//             </Link>
//           )}
