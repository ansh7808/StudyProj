            ...
            >
              ...
              <p className={`text-richblack-200`}>
                {/* <ul style={{ listStyle: 'none', padding: 0 }} >
                 ...
                 <ul style={{ listStyle: 'none', padding: 0 }}>
    <li style={{ display: 'flex', alignItems: 'flex-start' }} className="text-xl text-richblack-300">
      <span>{courseDescription.split('.')[0].trim()}.</span>
    </li>
  </ul>
              </p>
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden">
              ...
              <button className="yellowButton tracking-wider" onClick={handleBuyCourse}>
                Buy Now
              </button>
              <button className="blackButton  tracking-wider">Add to Cart</button>
            </div>
          </div>
          {/* Courses Card */}
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 border border-richblack-600 p-8">
            <p className="text-3xl font-semibold tracking-wider">What you'll Learn?</p>
            <div className="mt-5">
              ...
              <ul style={{ listStyle: 'none', padding: 0 }} className="leading-relaxed">
      {whatYouWillLearn.split('.').map((line, index) => {
