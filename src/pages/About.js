...
import Quote from "../components/core/AboutPage/Qoute"
    ...
    return (
      <div>
        ...
        <section className="bg-richblack-700">
         ...
         {/* section 2 */}
        <section className="border-b border-richblack-700 mt-10">
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          ...
          <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
            ...
            <div className="my-24 flex lg:w-[40%] flex-col gap-10">
              <h1 className="bg-gradient-to-b from-[#FF512F] to-[#F09819] bg-clip-text text-4xl font-semibold 
              text-transparent lg:w-[70%] ">
                Our Vision
              </h1>
              <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
            ...
            {/* Right box */}
            <div className="my-24 flex lg:w-[40%] flex-col gap-10">
              <h1 className="bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] text-transparent 
              bg-clip-text text-4xl font-semibold lg:w-[70%] ">
                Our Mission
              </h1>
              <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
      ...
      <div className="relative mx-auto my-10 flex w-11/12 max-w-maxContent flex-col items-center 
